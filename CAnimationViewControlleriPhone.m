//
//  CAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation CAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Cc"]) {
        ...
        capitalLetterOriginY = 186;
        smallLetterOriginX = 238;
        smallLetterOriginY = 244;
    }
    
    if ([currentLetter isEqualToString:@"C"]) {
        
        capitalLetterOriginX = 202;
        capitalLetterOriginY = 186;
