//
//  TenAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface TenAnimationViewControlleriPhone ()

@end

@implementation TenAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    strokeTwoStartXDefault = numberOriginX + 85;
    strokeTwoStartYDefault = numberOriginY;
    strokeTwoRadiusXDefault = numberOriginX + 143;
    strokeTwoRadiusYDefault = numberOriginY + 60;
    strokeTwoRadiusLength = 98;
    strokeTwoStartRadians = DEGREES_TO_RADIANS(-145);
    strokeTwoEndRadians = DEGREES_TO_RADIANS(145);
    strokeTwoDirection = YES;
    strokeTwoBottomRadiusXDefault = numberOriginX + 27;
	strokeTwoBottomRadiusYDefault = numberOriginY + 60;
	strokeTwoBottomRadiusLength = 98;
	strokeTwoBottomStartRadians = DEGREES_TO_RADIANS(32 );
	strokeTwoBottomEndRadians = DEGREES_TO_RADIANS(-39);
	strokeTwoBottomDirection = YES;
...
-(void)strokeTwo {
    ...
    strokeTwoAnimation.duration = 6 * (-1 * animationSpeedMultiplier);
    // Create the path for the last stroke.
