//
//  BAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation BAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Bb"]) {
        ...
        capitalLetterOriginX = 73;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 189;
        smallLetterOriginY = 171;
    }
    
    if ([currentLetter isEqualToString:@"B"]) {
        
        capitalLetterOriginX = 113;
        capitalLetterOriginY = 171;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeTwoBottomEndX = strokeTwoBottomEndXDefault + 80;
		strokeTwoBottomEndY = strokeTwoBottomEndYDefault - 73;
