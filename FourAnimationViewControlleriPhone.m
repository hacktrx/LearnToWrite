//
//  FourAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface FourAnimationViewControlleriPhone ()

@end

@implementation FourAnimationViewControlleriPhone
...
-(void)implementOrientationCoordinates {
    ...
    if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        ...
        strokeOneRightX = strokeOneRightXDefault + 80;
        strokeOneRightY = strokeOneRightYDefault - 73;
