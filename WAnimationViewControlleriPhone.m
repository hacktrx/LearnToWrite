//
//  WAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation WAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ww"]) {
        
        capitalLetterOriginX = 26;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 202;
        smallLetterOriginY = 238;
    }
    
    if ([currentLetter isEqualToString:@"W"]) {
        
        capitalLetterOriginX = 81;
        capitalLetterOriginY = 171;
	...
	strokeOneTopLeftXDefault = capitalLetterOriginX + 38;
	strokeOneTopLeftYDefault = capitalLetterOriginY + 117;
	strokeOneBottomXDefault = capitalLetterOriginX + 76;
	strokeOneBottomYDefault = capitalLetterOriginY;
	strokeOneTopRightXDefault = capitalLetterOriginX + 114;
	strokeOneTopRightYDefault = capitalLetterOriginY + 117;
	strokeOneEndXDefault = capitalLetterOriginX + 152;
	...
	strokeTwoTopLeftXDefault = smallLetterOriginX + 21;
	strokeTwoTopLeftYDefault = smallLetterOriginY + 48;
	strokeTwoBottomXDefault = smallLetterOriginX + 42;
	strokeTwoBottomYDefault = smallLetterOriginY;
	strokeTwoTopRightXDefault = smallLetterOriginX + 63;
	strokeTwoTopRightYDefault = smallLetterOriginY + 48;
	strokeTwoEndXDefault = smallLetterOriginX + 84;
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        ...
        if ([currentLetter isEqualToString:@"W"]) {
            ...
            capitalLetterOriginX = 101; //86;
            capitalLetterOriginY = 169;
            
        }
        
        if ([currentLetter isEqualToString:@"w"]) {
            
            smallLetterOriginX = 87; //91;
            smallLetterOriginY = 206;
        }
        //18
        //169
		strokeOneStartXDefault = capitalLetterOriginX + 62; //80;
		strokeOneStartYDefault = capitalLetterOriginY - 80; //89;
		strokeOneTopLeftXDefault = capitalLetterOriginX + 95; //113;
		strokeOneTopLeftYDefault = capitalLetterOriginY + 28; //197;
		strokeOneBottomXDefault = capitalLetterOriginX + 139; //157;
		strokeOneBottomYDefault = capitalLetterOriginY - 68; //101;
		strokeOneTopRightXDefault = capitalLetterOriginX + 182; //200;
		strokeOneTopRightYDefault = capitalLetterOriginY + 28; //197;
		strokeOneEndXDefault = capitalLetterOriginX + 215; //233;
		strokeOneEndYDefault = capitalLetterOriginY - 80; //89;
		//183
        //206
		strokeTwoStartXDefault = smallLetterOriginX + 82; //265;
		strokeTwoStartYDefault = smallLetterOriginY - 79; //127;
		strokeTwoTopLeftXDefault = smallLetterOriginX + 117; //300;
		strokeTwoTopLeftYDefault = smallLetterOriginY;
		strokeTwoBottomXDefault = smallLetterOriginX + 153; //336;
		strokeTwoBottomYDefault = smallLetterOriginY - 71; //135;
		strokeTwoTopRightXDefault = smallLetterOriginX + 188; //371;
		strokeTwoTopRightYDefault = smallLetterOriginY;
		strokeTwoEndXDefault = smallLetterOriginX + 225; //408;
		strokeTwoEndYDefault = smallLetterOriginY - 79; //127;
	}
	*/
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeOneTopLeftX = strokeOneTopLeftXDefault + 80;
		strokeOneTopLeftY = strokeOneTopLeftYDefault - 73;
		strokeOneBottomX = strokeOneBottomXDefault + 80;
		strokeOneBottomY = strokeOneBottomYDefault - 73;
		strokeOneTopRightX = strokeOneTopRightXDefault + 80;
		strokeOneTopRightY = strokeOneTopRightYDefault - 73;
		...
		strokeTwoTopLeftX = strokeTwoTopLeftXDefault + 80;
		strokeTwoTopLeftY = strokeTwoTopLeftYDefault - 73;
		strokeTwoBottomX = strokeTwoBottomXDefault + 80;
		strokeTwoBottomY = strokeTwoBottomYDefault - 73;
		strokeTwoTopRightX = strokeTwoTopRightXDefault + 80;
		strokeTwoTopRightY = strokeTwoTopRightYDefault - 73;
	...
	if (self.interfaceOrientation == UIInterfaceOrientationPortrait || self.interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
		...
		strokeTwoTopLeftX = strokeTwoTopLeftXDefault;
		strokeTwoTopLeftY = strokeTwoTopLeftYDefault;
		strokeTwoBottomX = strokeTwoBottomXDefault;
		strokeTwoBottomY = strokeTwoBottomYDefault;
		strokeTwoTopRightX = strokeTwoTopRightXDefault;
		strokeTwoTopRightY = strokeTwoTopRightYDefault;
...
-(void)strokeTwo {
	...
	CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoTopLeftX, strokeTwoTopLeftY);
	CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoBottomX, strokeTwoBottomY);
	CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoTopRightX, strokeTwoTopRightY);
