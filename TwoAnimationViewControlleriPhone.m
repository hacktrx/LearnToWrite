//
//  TwoAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface TwoAnimationViewControlleriPhone ()

@end

@implementation TwoAnimationViewControlleriPhone
...
if (strokeSoundSettingsBoolFlag == 1) {
    ...
    strokeOneRadiusXDefault = numberOriginX + 28;
    strokeOneRadiusYDefault = numberOriginY + 6;
    strokeOneRadiusLength = 26;
    strokeOneStartRadians = DEGREES_TO_RADIANS(-120);
    strokeOneEndRadians = DEGREES_TO_RADIANS(25);
    strokeOneDirection = NO;
    strokeOneBottomXDefault = numberOriginX - 1;
    strokeOneBottomYDefault = numberOriginY + 101;
    strokeOneEndXDefault = numberOriginX + 57;
    strokeOneEndYDefault = numberOriginY + 101;
