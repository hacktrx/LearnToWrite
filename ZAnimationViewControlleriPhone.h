//
//  ZAnimationViewControlleriPhone.h
//  LearnToWrite
//
...
@interface ZAnimationViewControlleriPhone : UIViewController {
	...
	CGFloat strokeOneBottomLeftXDefault;
	CGFloat strokeOneBottomLeftYDefault;
	...
	CGFloat strokeTwoBottomLeftXDefault;
	CGFloat strokeTwoBottomLeftYDefault;
	...
	CGFloat strokeOneBottomLeftX;
	CGFloat strokeOneBottomLeftY;
	...
	CGFloat strokeTwoBottomLeftX;
	CGFloat strokeTwoBottomLeftY;
