...
@implementation DAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"d"]) {
        ...
        smallLetterOriginX = 182;
        smallLetterOriginY = 467;
    }
