//
//  DAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation DAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Dd"]) {
        
        capitalLetterOriginX = 71;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 243;
        smallLetterOriginY = 260;
    }
    
    if ([currentLetter isEqualToString:@"D"]) {
	...
	strokeTwoRadiusXDefault = capitalLetterOriginX + 42;//45;//251;
	strokeTwoRadiusYDefault = capitalLetterOriginY + 58;//63;//587;
	strokeTwoRadiusLength = 58;//63;//116;
	strokeTwoStartRadians = DEGREES_TO_RADIANS(-90);
	strokeTwoEndRadians = DEGREES_TO_RADIANS(89);//(90);
    ...
    strokeThreeRadiusXDefault = smallLetterOriginX - 27;
	...
	strokeThreeEndXDefault = smallLetterOriginX;// - 66;
	strokeThreeEndYDefault = smallLetterOriginY;// + 335;
	
	strokeFourStartXDefault = smallLetterOriginX;
	strokeFourStartYDefault = smallLetterOriginY - 89;
	strokeFourEndXDefault = smallLetterOriginX;
	strokeFourEndYDefault = smallLetterOriginY + 26;
...
-(void)strokeThree {
	...
	strokeThreeAnimation.duration = 4 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
