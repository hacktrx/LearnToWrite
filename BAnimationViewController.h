...
@interface BAnimationViewController : UIViewController {
	...
	CGFloat strokeTwoBottomEndXDefault;
	CGFloat strokeTwoBottomEndYDefault;
	...
	CGFloat strokeTwoBottomEndX;
	CGFloat strokeTwoBottomEndY;
