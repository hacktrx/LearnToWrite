//
//  JAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation JAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Jj"]) {
        
        capitalLetterOriginX = 161;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 224;
        smallLetterOriginY = 239;
    }
    
    if ([currentLetter isEqualToString:@"J"]) {
        
        capitalLetterOriginX = 180;
        capitalLetterOriginY = 171;
	...
	strokeOneRadiusXDefault = capitalLetterOriginX - 45;
	strokeOneRadiusYDefault = capitalLetterOriginY + 71;
	strokeOneRadiusLength = 45;
	strokeOneStartRadians = DEGREES_TO_RADIANS(0);
	strokeOneEndRadians = DEGREES_TO_RADIANS(140);
	strokeOneDirection = NO;
	
    strokeTwoStartXDefault = capitalLetterOriginX - 35;
	strokeTwoStartYDefault = capitalLetterOriginY;
	strokeTwoEndXDefault = capitalLetterOriginX + 35;
	strokeTwoEndYDefault = capitalLetterOriginY;
    
	strokeThreeStartXDefault = smallLetterOriginX;
	strokeThreeStartYDefault = smallLetterOriginY;
	strokeThreeRadiusXDefault = smallLetterOriginX - 29;
	strokeThreeRadiusYDefault = smallLetterOriginY + 85;
	strokeThreeRadiusLength = 29;
	strokeThreeStartRadians = DEGREES_TO_RADIANS(0);
	strokeThreeEndRadians = DEGREES_TO_RADIANS(130);
	strokeThreeDirection = NO;
	
	strokeFourStartXDefault = smallLetterOriginX + 1;
	strokeFourStartYDefault = smallLetterOriginY - 41;
	strokeFourRadiusXDefault = smallLetterOriginX - 1;
	strokeFourRadiusYDefault = smallLetterOriginY - 41;
	strokeFourRadiusLength = 2;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeThreeRadiusX = strokeThreeRadiusXDefault + 80;
		strokeThreeRadiusY = strokeThreeRadiusYDefault - 73;
...
-(void)strokeTwo {
	...
	strokeTwoAnimation.duration = 1.50 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
...
-(void)strokeThree {
	...
	strokeThreeAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseIn];
	strokeThreeAnimation.fillMode = kCAFillModeForwards;
	strokeThreeAnimation.duration = 3 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
	...
	CGPathAddArc(strokeThreePath, NULL, strokeThreeRadiusX,strokeThreeRadiusY, strokeThreeRadiusLength, strokeThreeStartRadians, strokeThreeEndRadians, strokeThreeDirection);
