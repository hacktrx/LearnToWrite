//
//  NineAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface NineAnimationViewControlleriPhone ()

@end

@implementation NineAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    strokeOneRadiusXDefault = numberOriginX - 33;
    strokeOneRadiusYDefault = numberOriginY;
    strokeOneRadiusLength = 33;
    strokeOneStartRadians = DEGREES_TO_RADIANS(0);
    strokeOneEndRadians = DEGREES_TO_RADIANS(-359);
    strokeOneDirection = YES;
    
    strokeTwoStartXDefault = numberOriginX;
    strokeTwoStartYDefault = numberOriginY;
    strokeTwoEndXDefault = numberOriginX;
    strokeTwoEndYDefault = numberOriginY + 86;
