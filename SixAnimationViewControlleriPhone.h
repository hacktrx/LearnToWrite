//
//  SixAnimationViewControlleriPhone.h
//  LearnToWrite
//
...
@interface SixAnimationViewControlleriPhone : UIViewController {
    ...
    CGFloat strokeOneMiddleXDefault;
    CGFloat strokeOneMiddleYDefault;
    ...
    CGFloat strokeOneMiddleX;
    CGFloat strokeOneMiddleY;
