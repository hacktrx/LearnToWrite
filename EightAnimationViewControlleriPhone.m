//
//  EightAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface EightAnimationViewControlleriPhone ()

@end

@implementation EightAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    strokeOneRadiusXDefault = numberOriginX - 22;
    strokeOneRadiusYDefault = numberOriginY + 14;
    strokeOneRadiusLength = 24;
    strokeOneStartRadians = DEGREES_TO_RADIANS(-45);
    strokeOneEndRadians = DEGREES_TO_RADIANS(135);
    strokeOneDirection = YES;
    strokeOneEndXDefault = numberOriginX + 17;
	strokeOneEndYDefault = numberOriginY - 8;
	strokeOneBottomRadiusXDefault = numberOriginX - 21;
	strokeOneBottomRadiusYDefault = numberOriginY + 75;
	strokeOneBottomRadiusLength = 32;
	strokeOneBottomStartRadians = DEGREES_TO_RADIANS(-10);
	strokeOneBottomEndRadians = DEGREES_TO_RADIANS(200);
