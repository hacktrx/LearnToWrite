...
if ([currentLetter isEqualToString:@"z"]) {
    ...
    smallLetterOriginX = 140;
    smallLetterOriginY = 441;
}
...
if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
    ...
    strokeOneBottomLeftX = strokeOneBottomLeftXDefault + 0;
    strokeOneBottomLeftY = strokeOneBottomLeftYDefault - 0;
    ...
    strokeTwoBottomLeftX = strokeTwoBottomLeftXDefault + 0;
    strokeTwoBottomLeftY = strokeTwoBottomLeftYDefault - 0;
