//
//  RAnimationViewControlleriPhone.h
//  LearnToWrite
//
...
@interface RAnimationViewControlleriPhone : UIViewController {
	...
	CGFloat strokeTwoLegXDefault;
	CGFloat strokeTwoLegYDefault;
	...
	CGFloat strokeTwoLegX;
	CGFloat strokeTwoLegY;
