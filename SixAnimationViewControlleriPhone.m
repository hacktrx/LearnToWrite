//
//  SixAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface SixAnimationViewControlleriPhone ()

@end

@implementation SixAnimationViewControlleriPhone
...
-(void)implementOrientationCoordinates {
    ...
    if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        ...
        strokeOneMiddleX = strokeOneMiddleXDefault + 80;
        strokeOneMiddleY = strokeOneMiddleYDefault - 73;
