//
//  QAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation QAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Qq"]) {
        
        capitalLetterOriginX = 118;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 252;
        smallLetterOriginY = 260;
    }
    
    if ([currentLetter isEqualToString:@"Q"]) {
        
        capitalLetterOriginX = 156;
        capitalLetterOriginY = 171;
	...
	strokeOneRadiusXDefault = capitalLetterOriginX;
	strokeOneRadiusYDefault = capitalLetterOriginY + 60;
	strokeOneRadiusLength = 60;
	strokeOneStartRadians = DEGREES_TO_RADIANS(-90);
	strokeOneEndRadians = DEGREES_TO_RADIANS(-89);
	strokeOneDirection = YES;
	
	strokeTwoStartXDefault = capitalLetterOriginX + 25;
	strokeTwoStartYDefault = capitalLetterOriginY + 94;
	strokeTwoEndXDefault = capitalLetterOriginX + 50;
	strokeTwoEndYDefault = capitalLetterOriginY + 120;
	
	strokeThreeStartXDefault = smallLetterOriginX;
	strokeThreeStartYDefault = smallLetterOriginY;
	strokeThreeRadiusXDefault = smallLetterOriginX - 28;
	strokeThreeRadiusYDefault = smallLetterOriginY;
	strokeThreeRadiusLength =  28;
	strokeThreeStartRadians = DEGREES_TO_RADIANS(0);
	strokeThreeEndRadians = DEGREES_TO_RADIANS(-359);
	strokeThreeDirection = YES;
	
    strokeFourStartXDefault = smallLetterOriginX;
	strokeFourStartYDefault = smallLetterOriginY - 22;
	strokeFourRadiusXDefault = smallLetterOriginX + 22;
	strokeFourRadiusYDefault = smallLetterOriginY + 60;
	strokeFourRadiusLength =  34;
	strokeFourStartRadians = DEGREES_TO_RADIANS(123);
	strokeFourEndRadians = DEGREES_TO_RADIANS(33);
...
-(void)strokeThree {
	...
	strokeThreeAnimation.duration = 5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
...
-(void)strokeFour {
	...
	strokeFourAnimation.duration = 5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
