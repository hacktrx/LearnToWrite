//
//  TAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation TAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Tt"]) {
        
        capitalLetterOriginX = 134;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 214;
        smallLetterOriginY = 176;
    }
    
    if ([currentLetter isEqualToString:@"T"]) {
	...
	strokeTwoStartXDefault = capitalLetterOriginX - 45;
	strokeTwoStartYDefault = capitalLetterOriginY;
	strokeTwoEndXDefault = capitalLetterOriginX + 45;
	...
	strokeThreeEndYDefault = smallLetterOriginY + 115;
	
	strokeFourStartXDefault = smallLetterOriginX - 17;
	strokeFourStartYDefault = smallLetterOriginY + 54;
	strokeFourEndXDefault = smallLetterOriginX + 17;
	strokeFourEndYDefault = smallLetterOriginY + 54;
