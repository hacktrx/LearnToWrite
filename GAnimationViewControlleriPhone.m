//
//  GAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation GAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Gg"]) {
        
        capitalLetterOriginX = 160;
        capitalLetterOriginY = 187;
        smallLetterOriginX = 253;
        smallLetterOriginY = 263;
    }
    
    if ([currentLetter isEqualToString:@"G"]) {
        
        capitalLetterOriginX = 198;
        capitalLetterOriginY = 187;
	...
	strokeOneRadiusXDefault = capitalLetterOriginX - 43;
	strokeOneRadiusYDefault = capitalLetterOriginY + 44;
	strokeOneRadiusLength = 60;
	strokeOneStartRadians = DEGREES_TO_RADIANS(-51);
	strokeOneEndRadians = DEGREES_TO_RADIANS(0);
	strokeOneDirection = YES;
	strokeOneEndXDefault = capitalLetterOriginX - 40;
	strokeOneEndYDefault = capitalLetterOriginY + 44;
	
	strokeTwoStartXDefault = smallLetterOriginX;
	strokeTwoStartYDefault = smallLetterOriginY;
	strokeTwoRadiusXDefault = smallLetterOriginX - 27;
	strokeTwoRadiusYDefault = smallLetterOriginY;
	strokeTwoRadiusLength = 27;
	strokeTwoStartRadians = DEGREES_TO_RADIANS(-1);
	strokeTwoEndRadians = DEGREES_TO_RADIANS(1);
	strokeTwoDirection = YES;
	
	strokeThreeStartXDefault = smallLetterOriginX;
	strokeThreeStartYDefault = smallLetterOriginY - 24;
	strokeThreeRadiusXDefault = smallLetterOriginX - 26;
	strokeThreeRadiusYDefault = smallLetterOriginY + 64;
	strokeThreeRadiusLength = 27;
	strokeThreeStartRadians = DEGREES_TO_RADIANS(33);
	strokeThreeEndRadians = DEGREES_TO_RADIANS(123);
...
-(void)strokeThree {
	...
	strokeThreeAnimation.duration = 3.5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
