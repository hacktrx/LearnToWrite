...
@implementation YAnimationViewController
...
if ([currentLetter isEqualToString:@"Yy"]) {
    
    capitalLetterOriginX = 76;
    capitalLetterOriginY = 378;
    smallLetterOriginX = 190;
    smallLetterOriginY = 449;
}

if ([currentLetter isEqualToString:@"Y"]) {
...
strokeOneBottomXDefault = capitalLetterOriginX + 48;
strokeOneBottomYDefault = capitalLetterOriginY + 60;
strokeOneEndXDefault = capitalLetterOriginX + 96;
strokeOneEndYDefault = capitalLetterOriginY;

strokeTwoStartXDefault = capitalLetterOriginX + 47;
strokeTwoStartYDefault = capitalLetterOriginY + 60;
strokeTwoEndXDefault = capitalLetterOriginX + 47;
...
strokeThreeEndXDefault = smallLetterOriginX + 21;
strokeThreeEndYDefault = smallLetterOriginY + 51;

strokeFourStartXDefault = smallLetterOriginX + 42;
strokeFourStartYDefault = smallLetterOriginY;
strokeFourEndXDefault = smallLetterOriginX - 4;
strokeFourEndYDefault = smallLetterOriginY + 114;
