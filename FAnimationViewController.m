    //
//  FAnimationViewController.m
//  LearnToWrite
//
//  Created by Justin Hackett on 6/17/10.
...
@implementation FAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ff"]) {
        
        capitalLetterOriginX = 84;
        capitalLetterOriginY = 378;
        smallLetterOriginX = 241;
        smallLetterOriginY = 387;
    }
    
    if ([currentLetter isEqualToString:@"F"]) {
	...
	strokeFourRadiusXDefault = smallLetterOriginX - 16;//490;
	strokeFourRadiusYDefault = smallLetterOriginY + 13;//480;
	strokeFourRadiusLength = 20;
	strokeFourStartRadians = DEGREES_TO_RADIANS(-40);
	strokeFourEndRadians = DEGREES_TO_RADIANS(-180);
	strokeFourDirection = YES;
	strokeFourEndXDefault = smallLetterOriginX - 36;
	strokeFourEndYDefault = smallLetterOriginY + 109;
	
	strokeFiveStartXDefault = smallLetterOriginX - 49;
	strokeFiveStartYDefault = smallLetterOriginY + 52;
	strokeFiveEndXDefault = smallLetterOriginX - 24;
	strokeFiveEndYDefault = smallLetterOriginY + 52;
...
-(void)strokeFour {
	...
	strokeFourAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseOut];
