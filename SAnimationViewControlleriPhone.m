//
//  SAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation SAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ss"]) {
        
        capitalLetterOriginX = 155;
        capitalLetterOriginY = 179;
        smallLetterOriginX = 229;
        smallLetterOriginY = 239;
    }
    
    if ([currentLetter isEqualToString:@"S"]) {
        
        capitalLetterOriginX = 189;
        capitalLetterOriginY = 179;
	...
	strokeOneRadiusXDefault = capitalLetterOriginX - 35;
	strokeOneRadiusYDefault = capitalLetterOriginY + 15;
	strokeOneRadiusLength = 28;
	strokeOneStartRadians = DEGREES_TO_RADIANS(-45);
	strokeOneEndRadians = DEGREES_TO_RADIANS(113);
	strokeOneDirection = YES;
    strokeOneEndXDefault = capitalLetterOriginX - 13;
	strokeOneEndYDefault = capitalLetterOriginY - 4;
	strokeOneBottomRadiusXDefault = capitalLetterOriginX - 25;
	strokeOneBottomRadiusYDefault = capitalLetterOriginY + 80;
	strokeOneBottomRadiusLength = 36;
	strokeOneBottomStartRadians = DEGREES_TO_RADIANS(-55);
	strokeOneBottomEndRadians = DEGREES_TO_RADIANS(150);
	strokeOneBottomDirection = NO;
	
	strokeTwoStartXDefault = smallLetterOriginX;
	strokeTwoStartYDefault = smallLetterOriginY;
	strokeTwoRadiusXDefault = smallLetterOriginX - 20;
	strokeTwoRadiusYDefault = smallLetterOriginY + 6;
	strokeTwoRadiusLength = 15;
	strokeTwoStartRadians = DEGREES_TO_RADIANS(-42);
	strokeTwoEndRadians = DEGREES_TO_RADIANS(113);
	strokeTwoDirection = YES;
	strokeTwoBottomRadiusXDefault = smallLetterOriginX - 15;
	strokeTwoBottomRadiusYDefault = smallLetterOriginY + 36;
	strokeTwoBottomRadiusLength = 16;
	strokeTwoBottomStartRadians = DEGREES_TO_RADIANS(-55);
	strokeTwoBottomEndRadians = DEGREES_TO_RADIANS(150);
	strokeTwoBottomDirection = NO;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeTwoBottomRadiusX = strokeTwoBottomRadiusXDefault + 80;
		strokeTwoBottomRadiusY = strokeTwoBottomRadiusYDefault - 73;
	}
	...
	if (self.interfaceOrientation == UIInterfaceOrientationPortrait || self.interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
		...
		strokeTwoBottomRadiusX = strokeTwoBottomRadiusXDefault;
		strokeTwoBottomRadiusY = strokeTwoBottomRadiusYDefault;
	}
}
...
-(void)strokeTwo {
	...
	strokeTwoAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseIn];
	...
	CGPathAddArc(strokeTwoPath, NULL, strokeTwoBottomRadiusX, strokeTwoBottomRadiusY, strokeTwoBottomRadiusLength,
				 strokeTwoBottomStartRadians, strokeTwoBottomEndRadians, strokeTwoBottomDirection);
