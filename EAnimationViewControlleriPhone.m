//
//  EAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation EAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ee"]) {
        
        capitalLetterOriginX = 80;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 187;
        smallLetterOriginY = 257;
    }
    
    if ([currentLetter isEqualToString:@"E"]) {
	...
	strokeTwoEndXDefault = capitalLetterOriginX + 81;
	...
	strokeThreeEndXDefault = capitalLetterOriginX + 54;
	strokeThreeEndYDefault = capitalLetterOriginY + 59;
	
	strokeFourStartXDefault = capitalLetterOriginX;
	strokeFourStartYDefault = capitalLetterOriginY + 117;
	strokeFourEndXDefault = capitalLetterOriginX + 81;
	strokeFourEndYDefault = capitalLetterOriginY + 117;
	
	strokeFiveStartXDefault = smallLetterOriginX;
	strokeFiveStartYDefault = smallLetterOriginY;
	strokeFiveRadiusXDefault = smallLetterOriginX + 25;
	strokeFiveRadiusYDefault = smallLetterOriginY + 5;
	strokeFiveRadiusLength =  25;
	strokeFiveStartRadians = DEGREES_TO_RADIANS(-10);
	strokeFiveEndRadians = DEGREES_TO_RADIANS(-325);
...
-(void)strokeFour {
	...
	strokeFourAnimation.duration = 1.25 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
...
-(void)strokeFive {
	...
	strokeFiveAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseIn];
	strokeFiveAnimation.fillMode = kCAFillModeForwards;
	strokeFiveAnimation.duration = 5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
