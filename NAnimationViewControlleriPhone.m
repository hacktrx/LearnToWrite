//
//  NAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation NAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Nn"]) {
    ...
    if ([currentLetter isEqualToString:@"N"]) {
	...
	strokeOneBottomXDefault = capitalLetterOriginX + 93;
	strokeOneBottomYDefault = capitalLetterOriginY;
	strokeOneEndXDefault = capitalLetterOriginX + 93;
...
-(void)strokeOne {
	...
	strokeOneAnimation.duration = 5.5 * (-1 * animationSpeedMultiplier);
