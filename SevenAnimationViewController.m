//
//  SevenAnimationViewController.m
//  LearnToWrite
//
...
@interface SevenAnimationViewController ()

@end

@implementation SevenAnimationViewController
...
- (void)viewDidLoad {
    ...
    strokeOneLeftXDefault = numberOriginX + 56;
	strokeOneLeftYDefault = numberOriginY;    
    strokeOneEndXDefault = numberOriginX + 8;
...
-(void)implementOrientationCoordinates {
    ...
    if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        ...
        strokeOneLeftX = strokeOneLeftXDefault + 0;
		strokeOneLeftY = strokeOneLeftYDefault - 0;
