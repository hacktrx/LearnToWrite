...
@implementation TAnimationViewController
...
if ([currentLetter isEqualToString:@"Tt"]) {
    ...
    capitalLetterOriginX = 133;
    capitalLetterOriginY = 378;
    smallLetterOriginX = 213;
    smallLetterOriginY = 384;
}

if ([currentLetter isEqualToString:@"T"]) {
    
    capitalLetterOriginX = 158;
    capitalLetterOriginY = 378;
