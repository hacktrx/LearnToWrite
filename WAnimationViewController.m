...
@implementation WAnimationViewController
...
if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
    ...
    strokeTwoTopLeftX = strokeTwoTopLeftXDefault + 0;
    strokeTwoTopLeftY = strokeTwoTopLeftYDefault - 0;
    strokeTwoBottomX = strokeTwoBottomXDefault + 0;
    strokeTwoBottomY = strokeTwoBottomYDefault - 0;
    strokeTwoTopRightX = strokeTwoTopRightXDefault + 0;
    strokeTwoTopRightY = strokeTwoTopRightYDefault - 0;
