...
@implementation IAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ii"]) {
        ...
        capitalLetterOriginX = 144;
        capitalLetterOriginY = 378;
        smallLetterOriginX = 185;
        smallLetterOriginY = 447;
    }
    
    if ([currentLetter isEqualToString:@"I"]) {
        
        capitalLetterOriginX = 159;
        capitalLetterOriginY = 378;
