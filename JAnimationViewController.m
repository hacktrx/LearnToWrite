...
@implementation JAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Jj"]) {
        ...
        capitalLetterOriginX = 160;
        capitalLetterOriginY = 380;
        smallLetterOriginX = 223;
        smallLetterOriginY = 449;
    }
    
    if ([currentLetter isEqualToString:@"J"]) {
        
        capitalLetterOriginX = 179;
        capitalLetterOriginY = 380;
