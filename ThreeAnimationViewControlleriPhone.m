//
//  ThreeAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@interface ThreeAnimationViewControlleriPhone ()

@end

@implementation ThreeAnimationViewControlleriPhone
...
if (strokeSoundSettingsBoolFlag == 1) {
    ...
    strokeOneRadiusXDefault = numberOriginX + 29;
    strokeOneRadiusYDefault = numberOriginY + 8;
    strokeOneRadiusLength = 30;
    strokeOneStartRadians = DEGREES_TO_RADIANS(-165);
    strokeOneEndRadians = DEGREES_TO_RADIANS(70);
    strokeOneDirection = NO;
    strokeOneEndXDefault = numberOriginX + 25;
	strokeOneEndYDefault = numberOriginY + 40;
	strokeOneBottomRadiusXDefault = numberOriginX + 29;
	strokeOneBottomRadiusYDefault = numberOriginY + 69;
	strokeOneBottomRadiusLength = 30;
	strokeOneBottomStartRadians = DEGREES_TO_RADIANS(-100);
	strokeOneBottomEndRadians = DEGREES_TO_RADIANS(160);
