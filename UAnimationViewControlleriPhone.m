//
//  UAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation UAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Uu"]) {
        
        capitalLetterOriginX = 75;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 189;
        smallLetterOriginY = 239;
    }
    
    if ([currentLetter isEqualToString:@"U"]) {
	...
	strokeOneRadiusYDefault = capitalLetterOriginY + 76;
	strokeOneRadiusLength = 43;
	strokeOneStartRadians = DEGREES_TO_RADIANS(-179);
	strokeOneEndRadians = DEGREES_TO_RADIANS(-359);
	strokeOneDirection = YES;
	strokeOneEndXDefault = capitalLetterOriginX + 86;
	...
	strokeTwoRadiusXDefault = smallLetterOriginX + 24;
	strokeTwoRadiusYDefault = smallLetterOriginY + 27;
	strokeTwoRadiusLength = 24;
	strokeTwoStartRadians = DEGREES_TO_RADIANS(-179);
	strokeTwoEndRadians = DEGREES_TO_RADIANS(-359);
	strokeTwoDirection = YES;
	strokeTwoEndXDefault = smallLetterOriginX + 48;
	strokeTwoEndYDefault = smallLetterOriginY;
	
	strokeThreeStartXDefault = smallLetterOriginX + 48;
	strokeThreeStartYDefault = smallLetterOriginY;
	strokeThreeEndXDefault = smallLetterOriginX + 48;
	strokeThreeEndYDefault = smallLetterOriginY + 47;
...
-(void)strokeTwo {
	...
	strokeTwoAnimation.duration = 4.5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
