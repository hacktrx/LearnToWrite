//
//  KAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation KAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Kk"]) {
        
        capitalLetterOriginX = 82;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 190;
        smallLetterOriginY = 171;
    }
    
    if ([currentLetter isEqualToString:@"K"]) {
	...
	strokeTwoStartXDefault = capitalLetterOriginX + 81;
	strokeTwoStartYDefault = capitalLetterOriginY;
	strokeTwoRadiusXDefault = capitalLetterOriginX;
	strokeTwoRadiusYDefault = capitalLetterOriginY + 58;
	//strokeTwoRadiusLength = 2;
	//strokeTwoStartRadians = DEGREES_TO_RADIANS(-170);
	//strokeTwoEndRadians = DEGREES_TO_RADIANS(-190);
	//strokeTwoDirection = YES;
	strokeTwoEndXDefault = capitalLetterOriginX + 82;
	...
	strokeFourStartXDefault = smallLetterOriginX + 38;
	strokeFourStartYDefault = smallLetterOriginY + 65;
	strokeFourRadiusXDefault = smallLetterOriginX;
	strokeFourRadiusYDefault = smallLetterOriginY + 93;
	//strokeFourRadiusLength =  2;
	//strokeFourStartRadians = DEGREES_TO_RADIANS(-170);
	//strokeFourEndRadians = DEGREES_TO_RADIANS(-190);
	//strokeFourDirection = YES;
	strokeFourEndXDefault = smallLetterOriginX + 45;
...
-(void)showDotStrokeTwo {
	...
	showDotStrokeTwoAnimation.duration = 2 * (-1 * animationSpeedMultiplier);
...
-(void)strokeTwo {
	...
	strokeTwoAnimation.duration = 3.5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
	...
	CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoRadiusX, strokeTwoRadiusY);
...
-(void)showDotStrokeThree {
	...
	showDotStrokeThreeAnimation.duration = 1.25 * (-1 * animationSpeedMultiplier);
...
-(void)strokeFour {
	...
	strokeFourAnimation.duration = 3.5 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
	...
	CGPathAddLineToPoint(strokeFourPath, NULL, strokeFourRadiusX, strokeFourRadiusY);
