 //
//  AAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation AAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Aa"]) {
        ...
        capitalLetterOriginX = 123;
        capitalLetterOriginY = 176;
