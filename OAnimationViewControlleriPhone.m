//
//  OAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation OAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Oo"]) {
        
        capitalLetterOriginX = 120;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 227;
        smallLetterOriginY = 235;
    }
    
    if ([currentLetter isEqualToString:@"O"]) {
	...
	strokeOneRadiusYDefault = capitalLetterOriginY + 59;
	strokeOneRadiusLength = 59;
	...
	strokeTwoRadiusXDefault = smallLetterOriginX;
	strokeTwoRadiusYDefault = smallLetterOriginY + 28;
