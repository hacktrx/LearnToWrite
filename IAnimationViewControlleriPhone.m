//
//  IAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation IAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Ii"]) {
        
        capitalLetterOriginX = 145;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 186;
        smallLetterOriginY = 239;
    }
    
    if ([currentLetter isEqualToString:@"I"]) {
    ...
    strokeTwoStartXDefault = capitalLetterOriginX - 11;
	strokeTwoStartYDefault = capitalLetterOriginY;
	strokeTwoEndXDefault = capitalLetterOriginX + 11;
	strokeTwoEndYDefault = capitalLetterOriginY;
    
    strokeThreeStartXDefault = capitalLetterOriginX - 11;
	strokeThreeStartYDefault = capitalLetterOriginY + 117;
	strokeThreeEndXDefault = capitalLetterOriginX + 11;
	strokeThreeEndYDefault = capitalLetterOriginY + 117;
	...
	strokeFourEndYDefault = smallLetterOriginY + 48;
	
	strokeFiveStartXDefault = smallLetterOriginX + 4;
	strokeFiveStartYDefault = smallLetterOriginY - 40;
	strokeFiveRadiusXDefault = smallLetterOriginX;
	strokeFiveRadiusYDefault = smallLetterOriginY - 40;
	strokeFiveRadiusLength = 4;
	strokeFiveStartRadians = DEGREES_TO_RADIANS(0);
	strokeFiveEndRadians = DEGREES_TO_RADIANS(360);
	strokeFiveDirection = YES;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeFiveStart = CGPointMake((strokeFiveStartXDefault + 80), (strokeFiveStartYDefault - 73));
		strokeFiveRadiusX = strokeFiveRadiusXDefault + 80;
		strokeFiveRadiusY = strokeFiveRadiusYDefault - 73;
...
-(void)strokeThree {
	...
	strokeThreeAnimation.duration = 1.50 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
...
-(void)strokeFour {
	...
	strokeFourAnimation.duration = 1.50 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
...
-(void)strokeFive {
	...
	strokeFiveAnimation.duration = 2 * (-1 * animationSpeedMultiplier);
	// Create the path for the last stroke.
