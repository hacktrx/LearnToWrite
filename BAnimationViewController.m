//
//  BAnimationViewController.m
//  LearnToWrite
//
//  Created by Justin Hackett on 5/7/10.
...
@implementation BAnimationViewController
...
if ([currentLetter isEqualToString:@"Bb"]) {
    
    capitalLetterOriginX = 73;//0
    capitalLetterOriginY = 378;//207
    smallLetterOriginX = 188;//-1
    smallLetterOriginY = 379;//208
}

if ([currentLetter isEqualToString:@"B"]) {
    
    capitalLetterOriginX = 112;//-1
    capitalLetterOriginY = 378;//207
...
if ([currentLetter isEqualToString:@"b"]) {
    ...
    smallLetterOriginX = 129;//-1
    smallLetterOriginY = 378;//207
}
...
strokeTwoRadiusXDefault = capitalLetterOriginX + 69;
strokeTwoRadiusYDefault = capitalLetterOriginY + 28;
strokeTwoRadiusLength = 28;
strokeTwoStartRadians = DEGREES_TO_RADIANS(270);
...
strokeTwoBottomRadiusXDefault = capitalLetterOriginX + 69;
strokeTwoBottomRadiusYDefault = capitalLetterOriginY + 89;
strokeTwoBottomRadiusLength = 28;
strokeTwoBottomStartRadians = DEGREES_TO_RADIANS(270);
strokeTwoBottomEndRadians = DEGREES_TO_RADIANS(89);
strokeTwoBottomEndXDefault = capitalLetterOriginX;
strokeTwoBottomEndYDefault = capitalLetterOriginY + 117;
...
strokeThreeEndYDefault = smallLetterOriginY + 117;

strokeFourStartXDefault = smallLetterOriginX;
strokeFourStartYDefault = smallLetterOriginY + 92;
strokeFourRadiusXDefault = smallLetterOriginX + 28;
strokeFourRadiusYDefault = smallLetterOriginY + 92;
strokeFourRadiusLength =  28;
strokeFourStartRadians = DEGREES_TO_RADIANS(181);
strokeFourEndRadians = DEGREES_TO_RADIANS(-180);
...
if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
    ...
    strokeTwoBottomEndX = strokeTwoBottomEndXDefault + 0;
    strokeTwoBottomEndY = strokeTwoBottomEndYDefault - 0;
...
if (self.interfaceOrientation == UIInterfaceOrientationPortrait || self.interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
    ...
    strokeTwoBottomEndX = strokeTwoBottomEndXDefault;
    strokeTwoBottomEndY = strokeTwoBottomEndYDefault;
...
CGPathAddArc(strokeTwoPath, NULL, strokeTwoBottomRadiusX, strokeTwoBottomRadiusY, strokeTwoBottomRadiusLength,
             strokeTwoBottomStartRadians, strokeTwoBottomEndRadians, strokeTwoDirection);
CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoBottomEndX, strokeTwoBottomEndY);
