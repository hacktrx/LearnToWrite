...
@implementation PAnimationViewController
...
if ([currentLetter isEqualToString:@"Pp"]) {
    
    capitalLetterOriginX = 79;
    capitalLetterOriginY = 378;
    smallLetterOriginX = 185;
    smallLetterOriginY = 449;
}

if ([currentLetter isEqualToString:@"P"]) {
...
strokeTwoRadiusXDefault = capitalLetterOriginX + 64;
...
strokeTwoEndYDefault = capitalLetterOriginY + 58;
...
strokeFourStartYDefault = smallLetterOriginY + 21;
strokeFourRadiusXDefault = smallLetterOriginX + 28;
strokeFourRadiusYDefault = smallLetterOriginY + 22;
strokeFourRadiusLength =  28;
strokeFourStartRadians = DEGREES_TO_RADIANS(-180);
strokeFourEndRadians = DEGREES_TO_RADIANS(175);
strokeFourDirection = NO;
strokeFourEndXDefault = smallLetterOriginX;
strokeFourEndYDefault = smallLetterOriginY + 22;
