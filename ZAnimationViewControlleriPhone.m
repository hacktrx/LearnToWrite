//
//  ZAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation ZAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Zz"]) {
        
        capitalLetterOriginX = 86;
        capitalLetterOriginY = 171;
        smallLetterOriginX = 195;
        smallLetterOriginY = 234;
    }
    
    if ([currentLetter isEqualToString:@"Z"]) {
        
        capitalLetterOriginX = 122;
        capitalLetterOriginY = 171;
	...
	strokeOneTopRightXDefault = capitalLetterOriginX + 77;
	strokeOneTopRightYDefault = capitalLetterOriginY;
	strokeOneBottomLeftXDefault = capitalLetterOriginX;
	strokeOneBottomLeftYDefault = capitalLetterOriginY + 117;
	strokeOneEndXDefault = capitalLetterOriginX + 77;
	...
	strokeTwoTopRightXDefault = smallLetterOriginX + 31;
	strokeTwoTopRightYDefault = smallLetterOriginY;
	strokeTwoBottomLeftXDefault = smallLetterOriginX - 5;
	strokeTwoBottomLeftYDefault = smallLetterOriginY + 56;
	strokeTwoEndXDefault = smallLetterOriginX + 31;
	strokeTwoEndYDefault = smallLetterOriginY + 56;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeOneBottomLeftX = strokeOneBottomLeftXDefault + 80;
		strokeOneBottomLeftY = strokeOneBottomLeftYDefault - 73;
		...
		strokeTwoBottomLeftX = strokeTwoBottomLeftXDefault + 80;
		strokeTwoBottomLeftY = strokeTwoBottomLeftYDefault - 73;
	...
	if (self.interfaceOrientation == UIInterfaceOrientationPortrait || self.interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
		...
		strokeOneBottomLeftX = strokeOneBottomLeftXDefault;
		strokeOneBottomLeftY = strokeOneBottomLeftYDefault;
		...
		strokeTwoBottomLeftX = strokeTwoBottomLeftXDefault;
		strokeTwoBottomLeftY = strokeTwoBottomLeftYDefault;
...
-(void)strokeOne {
	...
	CGPathAddLineToPoint(strokeOnePath, NULL, strokeOneBottomLeftX, strokeOneBottomLeftY);
...
-(void)strokeTwo {
	...
	CGPathAddLineToPoint(strokeTwoPath, NULL, strokeTwoBottomLeftX, strokeTwoBottomLeftY);
