...
@protocol LTW_AlphabetViewDelegateiPhone <NSObject>
...
@interface AlphabetViewController : UIViewController <SegmentedSwitchDelegate> {
...
@property (weak) id<LTW_AlphabetViewDelegateiPhone> delegate;
