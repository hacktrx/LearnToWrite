    //
//  EAnimationViewController.m
//  LearnToWrite
//
//  Created by Justin Hackett on 6/16/10.
...
@implementation EAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"e"]) {
        ...
        smallLetterOriginX = 133;
        smallLetterOriginY = 464;
    }
