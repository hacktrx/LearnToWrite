...
@implementation SAnimationViewController
...
if ([currentLetter isEqualToString:@"Ss"]) {
    ...
    capitalLetterOriginX = 154;
    capitalLetterOriginY = 386;
    smallLetterOriginX = 228;
    smallLetterOriginY = 449;
}

if ([currentLetter isEqualToString:@"S"]) {
    
    capitalLetterOriginX = 188;
    capitalLetterOriginY = 386;
...
if ([currentLetter isEqualToString:@"s"]) {
    ...
    smallLetterOriginX = 172;
    smallLetterOriginY = 446;
}
...
if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
    ...
    strokeTwoBottomRadiusX = strokeTwoBottomRadiusXDefault + 0;
    strokeTwoBottomRadiusY = strokeTwoBottomRadiusYDefault - 0;
}
