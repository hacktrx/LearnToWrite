...
@implementation GAnimationViewController
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Gg"]) {
        ...
        capitalLetterOriginX = 159;//159;
        capitalLetterOriginY = 394;//394;
        smallLetterOriginX = 252;//252;
        smallLetterOriginY = 468;//473;
    }
    
    if ([currentLetter isEqualToString:@"G"]) {
        
        capitalLetterOriginX = 197;
        capitalLetterOriginY = 394;
