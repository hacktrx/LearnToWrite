//
//  MAnimationViewControlleriPhone.m
//  LearnToWrite
//
...
@implementation MAnimationViewControlleriPhone
...
- (void)viewDidLoad {
    ...
    if ([currentLetter isEqualToString:@"Mm"]) {
        ...
        capitalLetterOriginX = 33;
        capitalLetterOriginY = 287;
...
-(void)implementOrientationCoordinates {
	...
	if (self.interfaceOrientation == UIInterfaceOrientationLandscapeLeft || self.interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
		...
		strokeThreeMiddleX = strokeThreeMiddleXDefault + 80;
		strokeThreeMiddleY = strokeThreeMiddleYDefault - 73;
		strokeThreeNextRadiusX = strokeThreeNextRadiusXDefault + 80;
		strokeThreeNextRadiusY = strokeThreeNextRadiusYDefault - 73;
		strokeThreeRightX = strokeThreeRightXDefault + 80;
		strokeThreeRightY = strokeThreeRightYDefault - 73;
	}
